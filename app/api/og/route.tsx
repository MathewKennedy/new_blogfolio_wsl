...
export async function GET(req: NextRequest) {
    try {
        ...
        if(!title){
            return new Response("No title provided for this blog post", { status: 500})
        }
        ...
        return new ImageResponse(
            (<div tw="flex relative flex-col p-12 w-full h-full items-start text-black bg-white">
                ...
                <p tw="ml-2 font-bold text-2xl">Mathew Kennedy</p>
                </div>
        ...
        return new Response("Failed to generate og link image", { status: 500})
    }
}
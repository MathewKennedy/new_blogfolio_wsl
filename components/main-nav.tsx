...
export function MainNav(){
    ...
    return <nav className="flex items-center space-x-4 lg:space-x-6">
        ...
        <Link href="/projects" className={cn("text-sm font-medium transition-colors hover:text-primary hidden sm:inline-block", pathName === "/projects" ? "text-foreground" : "text-foreground/60")}>
            Projects
        </Link>

...
Above, we're looking at the binary dump for this particular frame. These are the 0s and 1s that are encoded as high and low voltage signals in wired connections, light pulses in fiber optic cables, and varying amplitude electromagnetic waves in wireless communications. 
...
<small className="dark:text-[skyblue] text-[#2233aa]">MAC addresses have been altered in this post.</small>
...
Wireshark displays the LG and IG bits visually using periods as bits in the first three bytes of the addresses.
...
Let's move on to examine the layer 3 IP packet in this frame.
